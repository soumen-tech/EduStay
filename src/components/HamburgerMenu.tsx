        ...
        <div className="mt-6 space-y-6">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <Link to="/map" className="block py-2 hover:text-primary transition-colors">
                Map
              </Link>
              <Link to="/about" className="block py-2 hover:text-primary transition-colors">
                About Us
              </Link>
              <Link to="/privacy" className="block py-2 hover:text-primary transition-colors">
                Privacy Policy
              </Link>
              <Link to="/feedback" className="block py-2 hover:text-primary transition-colors">
                Feedback
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-2">
                ...
                <span>Adisaptagram, Hooghly, West Bengal, India</span>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="h-4 w-4 text-primary flex-shrink-0" />
                <a href="mailto:support@edustay.com" className="hover:text-primary">
                  support@edustay.com
                </a>
              </div>
              <div className="flex items-center gap-2">
