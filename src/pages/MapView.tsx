...
const MapView = () => {
  const locations = [
    { id: 1, name: "Ghosh Residency PG", distance: "800m", lat: 22.8, lng: 88.4 },
    { id: 2, name: "Mitra Boys Hostel", distance: "1km", lat: 22.805, lng: 88.405 },
    { id: 3, name: "Saha Mess & Rooms", distance: "600m", lat: 22.795, lng: 88.395 },
    { id: 4, name: "AOT Comfort Stay", distance: "900m", lat: 22.802, lng: 88.402 },
  ];
      ...
      <main className="flex-1">
        ...
        <section className="gradient-hero text-white py-12">
          <div className="container mx-auto px-4">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">Nearby Rooms and PGs</h1>
            <p className="text-lg opacity-90">
              Properties near Academy of Technology, Adi Saptagram
            </p>
          </div>
        </section>
